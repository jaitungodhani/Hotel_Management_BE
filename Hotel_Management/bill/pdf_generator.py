...
class BillPdfGenerator:
    ...
    def onFirstPage(self, canvas, document):
        ...
        urllib.request.urlretrieve('https://res.cloudinary.com/drfdjango/image/upload/v1680432951/hotel_management/media/profile_photos/image_context_unnkdw.jpg','image_context.jpeg')
        pdf.drawImage(os.path.join(settings.BASE_DIR, "image_context.jpeg"), 215, 670, width=200, height=100)
        pdf.setLineWidth(2)
